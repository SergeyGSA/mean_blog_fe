...
import { IAuthServerError, IAuthServerResponse, ILoginData, IRegisterData } from "../../auth/auth.interface"
...
export const registerFailure = createAction('[Auth] register failure', props<{serverError: IAuthServerError}>())
...
export const loginFailure = createAction('[Auth] login failure', props<{serverError: IAuthServerError}>())
